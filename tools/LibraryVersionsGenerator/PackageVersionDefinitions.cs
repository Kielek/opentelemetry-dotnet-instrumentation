    ...
    [
        ...
        new()
        {
            ...
            [
                ...
                new NLogVersion("5.0.0") { NLogExtensionsLoggingVersion = "5.0.0" },
                new NLogVersion("5.3.4") { NLogExtensionsLoggingVersion = "5.3.15" }, // 5.3.0 - breaking change in the instrumented method contract
                new NLogVersion("6.0.0") { NLogExtensionsLoggingVersion = "6.0.0" }, // 6.0.0 - breaking change in the instrumented method contract
                new NLogVersion("*") { NLogExtensionsLoggingVersion = "*" }
            ]
        },
        new()
        {
